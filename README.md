...
5. For Cortex and HPOA datasets, external clustering evaluation indicators are used and the results can be obtained directly. For Prostate dataset, internal clustering evaluation indicators are used and the results can be obtained by running the “internal_evaluate.m” file and saving the “F” and “prel” variables. In addition,for Prostate dataset, it is necessary to hide the external evaluation indicator codes in the “main_MISF” file.
